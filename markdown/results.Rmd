...
These analyses reveal that certainty ratings are impacted by repetition similarly in both likert- and dichotomous response formats. In particular, repetition increases certainty for both "true" and "false" judgments. In practice when using likert scale response formats, this results in a decrease of truth rating for repeated statements judged "false", as increased certainty, reflected as increased distance from the midpoint, results in lower likert scale ratings. 

In addition to the impact of repetition on certainty, we analyzed the impact of scale formats on the effect size and reliability of the ITE. For the analyses below, we created counterfactual datasets where we artificially changed the response format from likert to dichotomous data and vice-versa.
