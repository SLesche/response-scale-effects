...
First, we re-analyzed the dichotomous data with separate certainty ratings originally analyzed in @stumpIllusoryCertaintyInformation2024. This effect was present for both “true” and “false” judgments, with the strongest increase for repeated “true” statements (see Figure \@ref(fig:dich-certainty-plot)). A multilevel model confirmed significant effects of repetition, truth judgment, and their interaction on certainty (all p < .001).
