...
The predictors (i) truth judgment and (ii) repetition status were dummy coded, using (i) “false” responses, and (ii) new statements as reference conditions. 

First, we re-analyzed the dichotomous data with separate certainty ratings originally analyzed in @stump2024. A multilevel model using truth judgment, repetition status, as well as their interaction as predictors for certainty ratings across all datasets, including random intercepts for subjects and datasets, revealed significant effects of repetition $b =$ `r summary(cert_model_dichotomous)$coefficients[2, 1] %>% apa_num()`, $SE =$ `r summary(cert_model_dichotomous)$coefficients[2, 2] %>% apa_num()`, `r paste0("t(", summary(cert_model_dichotomous)$coefficients[2, 3] %>% apa_num(), ") = ", summary(likert_model_certainty_by_repetition)$coefficients[2, 4] %>% apa_num())`, $p$ `r summary(cert_model_dichotomous)$coefficients[2, 5] %>% apa_p()`, truth judgment $b =$ `r summary(cert_model_dichotomous)$coefficients[3, 1] %>% apa_num()`, $SE =$ `r summary(cert_model_dichotomous)$coefficients[3, 2] %>% apa_num()`, `r paste0("t(", summary(cert_model_dichotomous)$coefficients[3, 3] %>% apa_num(), ") = ", summary(likert_model_certainty_by_repetition)$coefficients[3, 4] %>% apa_num())`, $p$ `r summary(cert_model_dichotomous)$coefficients[3, 5] %>% apa_p()`, and their interaction $b =$ `r summary(cert_model_dichotomous)$coefficients[4, 1] %>% apa_num()`, $SE =$ `r summary(cert_model_dichotomous)$coefficients[4, 2] %>% apa_num()`, `r paste0("t(", summary(cert_model_dichotomous)$coefficients[4, 3] %>% apa_num(), ") = ", summary(likert_model_certainty_by_repetition)$coefficients[4, 4] %>% apa_num())`, $p$ `r summary(cert_model_dichotomous)$coefficients[4, 5] %>% apa_p()`, indicating increased subjective certainty for "true" (vs. "false") judgments, repeated (vs. new) statements, with the strongest increase observed for repeated statements judged as true (see Figure \@ref(fig:dich-certainty-plot)). However, importantly, repetition increased certainty even when participants judged a statement as false.
...
We next analyzed Likert data, operationalizing “certainty” as distance from the scale midpoint. Responses were categorized as “true” (above midpoint) or “false” (below midpoint). A multilevel model using truth judgment, repetition status, and their interaction as predictors for artificial certainty ratings across all datasets, including random intercepts for subjects and datasets, revealed significant effects of repetition $b =$ `r summary(likert_model_certainty_by_repetition)$coefficients[2, 1] %>% apa_num()`, $SE =$ `r summary(likert_model_certainty_by_repetition)$coefficients[2, 2] %>% apa_num()`, 
`r paste0("t(", summary(likert_model_certainty_by_repetition)$coefficients[2, 3] %>% apa_num(), ") = ", summary(likert_model_certainty_by_repetition)$coefficients[2, 4] %>% apa_num())`, $p$ `r summary(likert_model_certainty_by_repetition)$coefficients[2, 5] %>% apa_p()`, truth judgment $b =$ `r summary(likert_model_certainty_by_repetition)$coefficients[3, 1] %>% apa_num()`, $SE =$ `r summary(likert_model_certainty_by_repetition)$coefficients[3, 2] %>% apa_num()`, `r paste0("t(", summary(likert_model_certainty_by_repetition)$coefficients[3, 3] %>% apa_num(), ") = ", summary(likert_model_certainty_by_repetition)$coefficients[3, 4] %>% apa_num())`, $p$ `r summary(likert_model_certainty_by_repetition)$coefficients[3, 5] %>% apa_p()`, and their interaction $b =$ `r summary(likert_model_certainty_by_repetition)$coefficients[4, 1] %>% apa_num()`, $SE =$ `r summary(likert_model_certainty_by_repetition)$coefficients[4, 2] %>% apa_num()`, `r paste0("t(", summary(likert_model_certainty_by_repetition)$coefficients[4, 3] %>% apa_num(), ") = ", summary(likert_model_certainty_by_repetition)$coefficients[4, 4] %>% apa_num())`, $p$ `r summary(likert_model_certainty_by_repetition)$coefficients[4, 5] %>% apa_p()`. Notably, although the effect of repetition on artificial certainty was stronger when statements were judged as true, we found that repetition increased artificial certainty even when statements were judged as false, indicating that truth judgments of repeated statements showed greater distance from the scale midpoint for both true and false judgments (see Figure \@ref(fig:likert-certainty-plot)).
